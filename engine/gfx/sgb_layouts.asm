...
.SGB_Pokedex:
	...
	call CopyBytes
	ld hl, wSGBPals + 3
	ld [hl], LOW((1 << 0) * 31 + (1 << 5) * 20 + (1 << 10) * 10)
	inc hl
	ld [hl], HIGH((1 << 0) * 31 + (1 << 5) * 20 + (1 << 10) * 10)
	inc hl
	ld [hl], LOW((1 << 0) * 26 + (1 << 5) * 10 + (1 << 10) * 6)
	inc hl
	ld [hl], HIGH((1 << 0) * 26 + (1 << 5) * 10 + (1 << 10) * 6)
	ld a, [wCurPartySpecies]
...
.SGB_Evolution:
	...
	; Egg
	ld hl, wSGBPals + 3
	ld [hl], LOW((1 << 0) * 7 + (1 << 5) * 7 + (1 << 10) * 7)
	inc hl
	ld [hl], HIGH((1 << 0) * 7 + (1 << 5) * 7 + (1 << 10) * 7)
	inc hl
	ld [hl], LOW((1 << 0) * 2 + (1 << 5) * 3 + (1 << 10) * 3)
	inc hl
	ld [hl], HIGH((1 << 0) * 2 + (1 << 5) * 3 + (1 << 10) * 3)
	jr .done
