...
_CGB_BattleGrayscale:
	...
	call CopyPalettes
	ld hl, PalPacket_BattleGrayscale + 1
	ld de, wBGPals1 + PALETTE_SIZE * PAL_BATTLE_BG_EXP
	ld c, 4
	call CopyPalettes
	ld hl, PalPacket_BattleGrayscale + 1
	ld de, wOBPals1
...
_CGB_StatsScreenHPPals:
	...
	ld de, wBGPals1 + PALETTE_SIZE * 3
	ld bc, 3 * PALETTE_SIZE ; pink, green, and blue page palettes
	ld a, BANK(wBGPals1)
	call FarCopyWRAM
	call WipeAttrmap
...
.got_palette
	...
	ld de, wOBPals1 + PALETTE_SIZE * 7 ; green cursor palette
	ld bc, 1 * PALETTE_SIZE
	ld a, BANK(wOBPals1)
	call FarCopyWRAM
	call ApplyAttrmap
...
.got_gender
	ld de, wBGPals1
	ld bc, 8 * PALETTE_SIZE ; 6 palettes?
	ld a, BANK(wBGPals1)
	call FarCopyWRAM
	call WipeAttrmap
	hlcoord 0, 0, wAttrmap
